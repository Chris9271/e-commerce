    ...
    return (
        <footer className="page-footer grey darken-1">
            <div className="row container">
                ...
                <div className="col l4 offset-12 s6">
                    <ul>
                ...
                <div className="col l4 offset-12 s6">
                    <ul>
                        <li><a className="white-text text-lighten-3" href="#!">Student Discount</a></li>
                        <li><a className="white-text text-lighten-3" href="#!">Privacy Policy</a></li>
                        <li><a className="white-text text-lighten-3" href="#!">Newsroom</a></li>
                    </ul>
                </div>
            </div>
        </footer>
